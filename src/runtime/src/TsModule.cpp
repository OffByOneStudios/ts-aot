...
TsValue* ts_module_get_builtin_modules() {
...
TsValue* ts_module_create_require(void* path) {
...
// Loader hooks are not applicable in AOT context
TsValue* ts_module_register_hooks(void* hooks) {
    (void)hooks;
...
TsValue* ts_module_find_package_json(void* startPath) {
    (void)startPath;
...
TsValue* ts_module_sourcemap_create(void* payload) {
